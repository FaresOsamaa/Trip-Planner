...
{
    public partial class Plan_C : Form
    {
        public Plan_C()
        {
            InitializeComponent();
        }
        private void Plan_A_Load(object sender, EventArgs e)
        {
        ...
        public void buttonNext_Click(object sender, EventArgs e)
        {
            ...
            France France = new France(selectedItemHotel, selectedItemAirLine,dateNumber);

            double total_price = France.TotalPrice();
            double hotal_price = France.HotelPrices();
            double air_plane = France.AirPlanePrices();
        ...
        private void dateTimePickerDepature_ValueChanged(object sender, EventArgs e)
        {
